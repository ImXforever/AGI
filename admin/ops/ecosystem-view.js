/* 3D Zenovix ecosystem simulator. THREE if present, canvas fallback otherwise. English only. */
(function () {
  "use strict";
  ...
  var NODES = [
    ...
    { id: "wa", label: "WhatsApp (optional)", ring: 1, color: 0x00ffa8, href: "inbox.html", kind: "channel",
      text: "Optional. Disabled channel returns 404. Never invent a Meta/Twilio secret." },
    ...
    { id: "emailag", label: "Email agent", ring: 0.72, color: 0x7af6ff, href: "inbox.html", kind: "agent",
      text: "Classify, reply_common, draft important mail. Finance and legal wait." },
    { id: "socialag", label: "Social agent", ring: 0.72, color: 0xff2bd6, href: "social.html", kind: "agent",
      text: "Calendar captions. Ordinary posts auto. Claims held." },
  ...
  var EDGES = [
    ...
    ["core", "emailag"], ["core", "socialag"], ["core", "sales"], ["core", "support"], ["core", "know"], ["core", "ops"],
    ["core", "hitl"], ["hitl", "core"],
  ...
  function spawnPacket() {
    ...
    packets.push({
      from: ch,
      via: "core",
      to: hold ? "hitl" : ["emailag", "socialag", "sales", "support", "know", "ops"][Math.floor(Math.random() * 6)],
      t: 0,
      hold: hold,
  ...
  function tick(now) {
    ...
    hctx.fillText("Whole ecosystem · channels → orchestrator → HITL/auto → storage · future agents inactive", 16, 22);
