...
REQUIRED_SCHEMA: dict[str, tuple[str, ...]] = {
    ...
    "products": (
        ...
        "specs",
        "is_active",
        # 1.4.0 — English-first catalog, per-language display, images, codes
        "code",
        "title_en",
        "names",
        "titles",
    ...
    "product_images": ("product_id", "mime", "data", "size"),
    "catalog_categories": ("key", "name_en", "names", "icon", "sort_order", "is_active"),
    ...
    "agent_soul": ("id", "agent_name", "role_title", "mission", "tone", "style_rules", "is_active"),
    "audit_log": (
        "id",
        "actor",
        "action",
        ...
        "old_value",
        "new_value",
        # written by app.storage.pg.audit() — added in migration 0016
        "entity",
        "details",
        "conversation_id",
        "channel",
