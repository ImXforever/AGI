...
--
-- Postgres is the durable ledger. Redis is consume-once.
-- Missing meta (orphan pending row) is claimable if decided_key is absent.
...
if redis.call('EXISTS', decided_key) == 1 then
    return 0
end
