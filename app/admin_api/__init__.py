"""Zenovix-Agent Platform — Admin API router.
...
from app.admin_api.charter import router as _charter_router  # noqa: E402
...
from app.admin_api.database import router as _database_router  # noqa: E402
from app.admin_api.desk import router as _desk_router  # noqa: E402
...
from app.admin_api.security import router as _security_router  # noqa: E402
from app.admin_api.settings import router as _settings_router  # noqa: E402
from app.admin_api.simulator import router as _simulator_router  # noqa: E402
from app.admin_api.soul import router as _soul_router  # noqa: E402
...
router.include_router(_desk_router)
...
router.include_router(_charter_router)
router.include_router(_settings_router)
router.include_router(_soul_router)
router.include_router(_security_router)
router.include_router(_simulator_router)
router.include_router(_database_router)
