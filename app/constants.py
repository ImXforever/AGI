...
# Single source of truth for the product version. pyproject.toml, /healthz,
# /buildinfo, the OpenAPI title, the MCP serverInfo and the public site all
# read this — never hand-copy the string again (1.3.1, bug #7 class).
APP_VERSION = "1.6.0"
...
CHANNEL_EMAIL = "email"
CHANNEL_WEB = "web"
CHANNELS = frozenset({CHANNEL_TELEGRAM, CHANNEL_WHATSAPP, CHANNEL_EMAIL, CHANNEL_WEB})
