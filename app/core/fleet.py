"""Zenovix-Agent Fleet — one query, one team.
...
def platform_facts() -> str:
    ...
    cfg = get_config()
    return (
        f"Zenovix-Agent platform constants:\n"
...
async def _call(
    ...
    *,
    ...
    """Make an LLM call for a fleet role via Zenovix-Agent's LLMClient."""
