...
class Page:
    ...
    def to_html(self) -> str:
        ...
        desc = html.escape(self.meta_description, quote=True)
        return (
            f"<!DOCTYPE html>\n<html lang='en'>\n<head>\n"
...
def publish_page(
    ...
    *,
    ...
    action: str = "publish_content",
) -> Page:
    """Publish only when central policy allows. A bare approved flag is not enough."""
...
def archive_page(
    ...
    *,
    ...
    """Archive is a delete-class action — never live without a manager record."""
    from app.core.policy import evaluate_action
