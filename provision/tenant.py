#!/usr/bin/env python3
"""Tenant provisioning CLI for Zenovix-Agent Platform.
...
# =============================================================================
# Zenovix-Agent Platform â€” Generated for tenant: {tenant_id}
...
def provision_from_args(args: argparse.Namespace) -> dict[str, Any]:
    return {
        ...
        "r2_bucket": args.r2_bucket or "Zenovix-Agent-assets",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Provision a new Zenovix-Agent tenant")
