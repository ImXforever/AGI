...
class TestPagePublish:
    ...
    def test_publish_with_approval(self):
        page = create_page("Test", "Content")
        page = publish_page(page, approved=True, approval_id="rec-1", actor_role="admin")
        assert page.status == PageStatus.PUBLISHED
        assert page.published_at is not None

    def test_publish_approved_flag_without_id_stays_review(self):
        page = create_page("Test", "Content")
    ...
    def test_archive(self):
        ...
        assert page.status == PageStatus.DRAFT
        page = archive_page(page, approved=True, approval_id="rec-1", actor_role="admin")
...
class TestPageFiltering:
    def test_get_published(self):
        ...
        p1 = publish_page(p1, approved=True, approval_id="rec-1", actor_role="admin")
