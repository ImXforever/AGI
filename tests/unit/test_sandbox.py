...
class TestRunShell:
    ...
    async def test_allow_all_mode_skips_the_approval_prompt(self, monkeypatch: pytest.MonkeyPatch):
    ...
    async def test_yolo_mode_skips_the_approval_prompt(self, monkeypatch: pytest.MonkeyPatch):
    ...
    async def test_production_ignores_yolo_and_allow_all(self, monkeypatch: pytest.MonkeyPatch):
        monkeypatch.setenv("APP_ENV", "production")
